    ...
    constructor(client) {
        ...
        this.exec = async (message, args, prefix) => {
            ...
            if (args[0].toLowerCase() === `player`) {
                ...
                let b1 = this.client.utils.button(`custom_id`, `Oras Classic`, 2, `oras_classic_mode`);
                let b2 = this.client.utils.button(`custom_id`, `Oras x Spotify`, 3, `oras_spotify_mode`);
                let b3 = this.client.utils.button(`custom_id`, `Oras Simple`, 2, `oras_simple_mode`);
                let b4 = this.client.utils.button(`custom_id`, `Oras Special`, 1, `oras_special_mode`);
                let b5 = this.client.utils.button(`custom_id`, `No Buttons Style`, 2, `oras_no_mode`);
                let b6 = this.client.utils.button(`custom_id`, `Oras Old School`, 2, `oras_old_mode`);
